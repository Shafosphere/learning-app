// src/components/__tests__/Account.test.jsx
...
// Mock navigation and window width hooks
...
// Prepare mocked navigation and popup contexts
...
describe("Account Component", () => {
  ...
  // Helper to locate input by its label text
  ...
  it("should toggle password visibility", async () => {
    ...
    const toggleBtn = oldPassInput
      .closest(".input-group")
      .querySelector(".btn-pass-acc");
  ...
  it("should handle save with validation failure", async () => {
  ...
  it("should switch tabs on mobile screens", async () => {
  ...
  it("should show error popup on API failure", async () => {
    ...
    // Change field value to enable button
    const usernameInput = await findInputByLabel(/username/i);
    await act(async () => {
